       ...
       DATE-WRITTEN.  1/19/2021.
       DATE-COMPILED.
      ************************************************
      *                                              *
      * WRITES A SALES REPORT FOR PARKS WITH A MAJOR *
      * CONTROL BREAK ON EACH PARK.                  *
      *                                              *
      ************************************************
      ...
      * HOLD VARIABLE FOR CONTROL BREAK CHECKS *
           05  H-PARK              PIC 99.
      ...
      * UNPACKS AND FORMATS THE ATTENDANCE DATE *
      ...
      * MOVES AND FORMATS MAJOR SUBTOTALS DATA *
           MOVE T-PARK-NAME(H-PARK) TO O-MJ-PARK-NAME.
