      ...
      **************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT LICENSES-REC
               ASSIGN TO 
               'C:\IHCC\WINTER 2020\COBOL III\COBLSC01\SRTHUNT.DAT'
      *        ASSIGN TO SORTOUT               ON MAINFRAME
               ORGANIZATION IS LINE SEQUENTIAL.
      *        ORGANIZATION IS SEQUENTIAL.     ON MAINFRAME

           SELECT PRTOUT
               ASSIGN TO 
               'C:\IHCC\WINTER 2020\COBOL III\COBLSC01\LICREPT.PRT'
      *        ASSIGN TO LICREPT               ON MAINFRAME
      ...
      *        ORGANIZATION IS SEQUENTIAL.     ON MAINFRAME
       ...
       FD  LICENSES-REC
           ...
           RECORD CONTAINS 5 TO 37 CHARACTERS
           DATA RECORDS IS LICENSE-RECS.

       01  H-DETAIL-REC.
           05  FILLER              PIC X.
           05  H-CUSTID            PIC X(9).
      *    05  H-CUST-BDAY         PIC 9(8)    COMP-3. ON MAINFRAME
           05  H-CUST-BDAY         PIC 9(8).
           05  H-CUST-SAFETY-NO    PIC X(10).
           05  H-L-TYPE            PIC 99.
           05  H-SEASON            PIC 9.
           05  H-RESIDENT          PIC X.
      *    05  H-FEE               PIC 9(3)V99 COMP-3. ON MAINFRAME
           05  H-FEE               PIC 9(3)V99.
      ...
      * SUBSCRIPT FOR THE HEADERS TABLE *
           05  LICENSE-SUB         PIC 99      VALUE 0 COMP.
      * CHECKS WHICH REPORT SHOULD BE PRINTED *
      ...
      * SETS UP THE HEADER RECORDS TABLE *
       ...
       L2-MAINLINE.
      * CHECKS WHAT ACTIONS SHOULD TAKE PLACE BASED ON R-TYPE *
           IF R-TYPE = 'H'
      ...
      * MOVES AND FORMATES DATA TO FINISH PRINTING A SUMMARY REPORT *
      ...
      * ADDS TO A CTR DEPENDING IN IF THE CUSTOMER IS A RESIDENT *
           IF D-RESIDENT = 'R'
       ...
       L3-OUTPUT.
      * MOVED AND FORMATS DATA TO PRINT A DETAIL REPORT *
      ...
      * CHECKS WHICH REPORT IS CURRENTLY BEING WORKED ON TO DETERMINE *
      * WHAT TO PRINT                                                 *
           IF REPORT-CHECK = 'D'
      * WRITES THE FIRST LINES OF THE DETAIL REPORT *
               ...
               WRITE PRTLINE FROM BLANK-LINE
                   AFTER ADVANCING 1 LINE
           ELSE
      * WRITES THE FIRST LINES OF THE SUMMARY REPORT *
               IF REPORT-CHECK = 'S'
	  ...
	  * MOVES RECORDS TO RECORD LAYOUTS BASED ON R-TYPE *
		   ...
		   ELSE
			   IF R-TYPE = 'D'
	  *   		   MOVE H-DETAIL-REC TO DETAIL-REC.   ON MAINFRAME
                   MOVE H-CUSTID TO D-CUSTID
                   MOVE H-CUST-BDAY TO D-CUST-BDAY
                   MOVE H-CUST-SAFETY-NO TO D-CUST-SAFETY-NO
                   MOVE H-L-TYPE TO D-L-TYPE
                   MOVE H-SEASON TO D-SEASON
                   MOVE H-RESIDENT TO D-RESIDENT
                   MOVE H-FEE TO D-FEE.